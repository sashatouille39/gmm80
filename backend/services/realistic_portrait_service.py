...
class RealisticPortraitService:
    ...
    NATIONALITY_TO_CONTINENT_ETHNICITY = {
        ...
        'Estonienne': ('europe', 'white'),
        'Letton': ('europe', 'white'),
        'Lettone': ('europe', 'white'),
        'Lituanien': ('europe', 'white'),
        'Lituanienne': ('europe', 'white'),
        'Russe': ('europe', 'white'),
        ...
        # MOYEN-ORIENT & AFRIQUE DU NORD - Middle Eastern
        'Algérien': ('middle_east', 'middle_eastern'),
        'Algérienne': ('middle_east', 'middle_eastern'),
        'Égyptien': ('middle_east', 'middle_eastern'),
        'Égyptienne': ('middle_east', 'middle_eastern'),
        'Libyen': ('middle_east', 'middle_eastern'),
        'Libyenne': ('middle_east', 'middle_eastern'),
        'Marocain': ('middle_east', 'middle_eastern'),
        'Marocaine': ('middle_east', 'middle_eastern'),
        'Tunisien': ('middle_east', 'middle_eastern'),
        'Tunisienne': ('middle_east', 'middle_eastern'),
        'Saoudien': ('middle_east', 'middle_eastern'),
        'Saoudienne': ('middle_east', 'middle_eastern'),
        'Émirati': ('middle_east', 'middle_eastern'),
        'Émiratie': ('middle_east', 'middle_eastern'),
        'Qatari': ('middle_east', 'middle_eastern'),
        'Qatarie': ('middle_east', 'middle_eastern'),
        'Koweïtien': ('middle_east', 'middle_eastern'),
        'Koweïtienne': ('middle_east', 'middle_eastern'),
        'Bahreïni': ('middle_east', 'middle_eastern'),
        'Bahreïnie': ('middle_east', 'middle_eastern'),
        'Omanais': ('middle_east', 'middle_eastern'),
        'Omanaise': ('middle_east', 'middle_eastern'),
        'Yéménite': ('middle_east', 'middle_eastern'),
        'Jordanien': ('middle_east', 'middle_eastern'),
        'Jordanienne': ('middle_east', 'middle_eastern'),
        'Libanais': ('middle_east', 'middle_eastern'),
        'Libanaise': ('middle_east', 'middle_eastern'),
        'Syrien': ('middle_east', 'middle_eastern'),
        'Syrienne': ('middle_east', 'middle_eastern'),
        'Irakien': ('middle_east', 'middle_eastern'),
        'Irakienne': ('middle_east', 'middle_eastern'),
        ...
        'Palestinienne': ('middle_east', 'middle_eastern'),
        ...
        'Azérie': ('middle_east', 'middle_eastern'),
        ...
        'Fidjienne': ('oceania', 'white'),
        'Papou-Néo-Guinéen': ('oceania', 'white'),
        'Papou-Néo-Guinéenne': ('oceania', 'white'),
        'Samoan': ('oceania', 'white'),
        'Samoane': ('oceania', 'white'),
        'Tongien': ('oceania', 'white'),
        'Tongienne': ('oceania', 'white'),
        'Vanuatais': ('oceania', 'white'),
        'Vanuataise': ('oceania', 'white'),
        'Salomonais': ('oceania', 'white'),
        'Salomonaise': ('oceania', 'white'),
        'Micronésien': ('oceania', 'white'),
        'Micronésienne': ('oceania', 'white'),
        'Palaosien': ('oceania', 'white'),
        'Palaosienne': ('oceania', 'white'),
        'Marshallais': ('oceania', 'white'),
        'Marshallaise': ('oceania', 'white'),
        'Nauruan': ('oceania', 'white'),
        'Nauruane': ('oceania', 'white'),
        'Kiribatien': ('oceania', 'white'),
        'Kiribatienne': ('oceania', 'white'),
        'Tuvaluan': ('oceania', 'white'),
        'Tuvaluane': ('oceania', 'white'),
    }
